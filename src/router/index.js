...
import LeaderboardView from '../views/AdminFolder/LeaderboardView.vue'
import PlacementView from '../views/AdminFolder/PlacementView.vue'
...
import SettingsProfile from '../views/AdminFolder/SettingsBrand/SettingsProfile.vue'
import SettingsDepartments from '../views/AdminFolder/SettingsBrand/SettingsDepartments.vue'
import SettingsMembers from '../views/AdminFolder/SettingsBrand/SettingsMembers.vue'
import SettingsIdentityVerification from '../views/AdminFolder/SettingsBrand/SettingsIdentityVerification.vue'
...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: 'company_sign_in',
        name: 'company_sign_in',
      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            ...
            name: 'setting-identity-verification',
            component: SettingsIdentityVerification
          },
        ]
      }
    ]
